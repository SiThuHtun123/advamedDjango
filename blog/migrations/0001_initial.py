# Generated by Django 3.2.5 on 2021-10-14 11:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 14, 11, 36, 43, 962982, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 14, 11, 36, 43, 962462, tzinfo=utc))),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 14, 11, 36, 43, 963969, tzinfo=utc))),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]

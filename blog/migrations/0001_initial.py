# Generated by Django 3.2.5 on 2021-10-13 15:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_no', models.CharField(default='N/A', max_length=1000)),
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 13, 15, 14, 58, 358815, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('no', models.CharField(default='N/A', max_length=1000)),
                ('product_description', models.TextField(default='N/A', max_length=10000)),
                ('brand', models.CharField(default='N/A', max_length=1000)),
                ('model', models.CharField(default='N/A', max_length=1000)),
                ('s_n', models.CharField(default='N/A', max_length=1000)),
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 13, 15, 14, 58, 358307, tzinfo=utc))),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2021, 10, 13, 15, 14, 58, 359785, tzinfo=utc))),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
